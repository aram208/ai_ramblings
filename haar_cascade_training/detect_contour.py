...
im1 = cv2.imread('originals/countur_test.jpg')
im2 = cv2.imread('originals/countur_test.jpg')
im3 = cv2.imread('originals/countur_test.jpg')
im4 = cv2.imread('originals/countur_test.jpg')
im5 = cv2.imread('originals/countur_test.jpg')
...
cv2.imwrite("test_marked_1.jpg", im1)
...
cv2.imwrite("test_marked_2.jpg", im2)
...
cv2.imwrite("test_marked_3.jpg", im3)
...
cv2.imwrite("test_marked_4.jpg", im4)
...
cv2.imwrite("test_marked_5.jpg", im5)
